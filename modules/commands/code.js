...
module.exports.run = async ({ api, event, args, Users }) => {
  ...
  else if(event.type == "message_reply" && (event.messageReply.body.indexOf('https://www.phamvandien.xyz') !== -1 || event.messageReply.body.indexOf('https://tinyurl.com') !== -1)) {
